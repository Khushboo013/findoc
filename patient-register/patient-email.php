        ...
        <div class="right w-[46.5%] border-2 border-gray-100 rounded mb-16 mt-12">
            <div class="m-12">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <!-- <button class="mt-6 w-full border-[1px] border-gray-100 rounded focus-within:border-[#09e5ab]"> -->
                    <div class="mt-4">
                        <?php
             ...
             if (isset($_SESSION['id'])) {
                 if (isset($_POST['submit'])) {
                     ...
                     $sql_dup = "SELECT * from `patient_register` WHERE `patient_email` = '$email'";
                     ...
                     if ($email_row) {
                         ...
                         $sql = "UPDATE `patient_register` SET `patient_email` = '$email' WHERE `patient_register`.`patient_id` = $id";
                         $result = mysqli_query($conn, $sql);
                         if ($result) {
                             // echo "email updated";
                             echo '<script>
                             window.location.href = "/patient-register/patient-identity.php"
                             </script>';
             ...
             ?>
                    ...
                    <div class="mt-6 w-full border-[1px] border-gray-100 rounded focus-within:border-[#09e5ab]">

                        <input class="outline-none rounded w-[34rem] mr-3 p-3 bg-transparent" type="email" name="email"
                            id="" placeholder="Email Address" required><i class="fa-regular fa-envelope mr-3"></i>

                    </div>
                    <!-- </button> -->
                    <!-- <a href="/patient-register/patient-identity.html" class=""> -->
                    <button name="submit"
